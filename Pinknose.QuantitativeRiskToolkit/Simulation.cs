...
namespace Pinknose.QuantitativeRiskToolkit
{
    public static class Simulation
    {
        ...
        */
        ...
        internal static bool DistributionExists(Guid guid) => distributions.ContainsKey(guid);

        public static void ClearDistributionList() => distributions.Clear();
        ...
        internal static bool DeserializationInProgress { get; private set; }

        public static void Deserialize(string json)
        {
            DeserializationInProgress = true;
            ...
            DeserializationInProgress = false;
        }
    }
}
